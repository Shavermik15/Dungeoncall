    ...
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            try
            {
                ...
                label7.Text = TheMainCharacter.Damage.ToString();
                label8.Text = TheMainCharacter.CritRate.ToString() + "%";
            }
            catch (Exception er)
            {
                ...
                switch (pass1)
                {
                    case 1:
                        ...
                        if (chancewithfire == 0 || chancewithfire == 1)
                        {
                            ...
                            priority++;
                            //chanceofmonsters = random.Next(2);
                            chanceofmonsters = 0;
                            switch (chanceofmonsters)
                            {
                                case 0:
                                    Form4 form4 = new Form4 (TheMainCharacter, TheWandererSpider, priority);
                                    form4.ShowDialog();
                                    break;
                                case 1:
                                    break;
                    ...
                    case 2:
                        ...
                        switch (chansmimics)
                        {
                            ...
                            case 0:
                                ...
                                break;
                            case 1:
                                textBox1.Text = "Вы подходите к сундуку и пробуете его открыть. У вас получилось! Внутри вы находите (предмет)";
                                break;
